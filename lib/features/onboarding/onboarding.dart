...
class _OnboardingState extends State<Onboarding> {
  ...
  final _pages = const <_OnboardPageData>[
    _OnboardPageData(
      ...
      description:
          'Get AI-powered insights, instant answers, and real-time alerts. Upsenso helps you understand your sales, inventory, and expenses — and flags unusual activity before it costs you.',
    ),
    _OnboardPageData(
